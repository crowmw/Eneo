...
!function (e, define) { define(["./kendo.data.min", "./kendo.columnsorter.min", "./kendo.editable.min", "./kendo.window.min", "./kendo.filtermenu.min", "./kendo.columnmenu.min", "./kendo.groupable.min", "./kendo.pager.min", "./kendo.selectable.min", "./kendo.sortable.min", "./kendo.reorderable.min", "./kendo.resizable.min", "./kendo.mobile.actionsheet.min", "./kendo.mobile.pane.min", "./kendo.ooxml.min", "./kendo.excel.min", "./kendo.pdf.min"], e) }(function () {
    return function (e, t) {
        ...
        }); ft.ExcelMixin && ft.ExcelMixin.extend(Dn.prototype), ft.PDFMixin && (ft.PDFMixin.extend(Dn.prototype), Dn.prototype._drawPDF = function (t) { function n() { c ? (l.unbind("change", i), l.one("change", function () { a.resolve(o) }), l.page(r)) : a.resolve(o) } function i() { s._drawPDFShadow().done(function (e) { var i = l.page(), r = c ? l.totalPages() : 1, a = { page: e, pageNumber: i, progress: i / r, totalPages: r }; t.notify(a), o.append(a.page), r > i ? l.page(i + 1) : n() }).fail(function (e) { a.reject(e) }) } var o, r, a = new e.Deferred, s = this, l = s.dataSource, c = s.options.pdf.allPages; return this._initPDFProgress(t), o = new ft.drawing.Group, r = l.page(), c ? (l.bind("change", i), l.page(1)) : i(), a.promise() }, Dn.prototype._initPDFProgress = function (t) { var n, i = e("<div class='k-loading-pdf-mask'><div class='k-loading-color'/></div>"); i.prepend(this.wrapper.clone().css({ position: "absolute", top: 0, left: 0 })), this.wrapper.append(i), n = e("<div class='k-loading-pdf-progress'>").appendTo(i).kendoProgressBar({ type: "chunk", chunkCount: 10, min: 0, max: 1, value: 0 }).data("kendoProgressBar"), t.progress(function (e) { n.value(e.progress) }).always(function () { ft.destroy(i), i.remove() }) }), pt.plugin(Dn), pt.plugin(Sn)
